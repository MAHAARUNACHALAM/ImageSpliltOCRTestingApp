...
class _cropperState extends State<cropper> {
  ...
  loadModel() async {
    await Tflite.loadModel(
      ...
      model: "assets/model_unquant_tilt.tflite",
...
//Google Ml Kit
    ...
    final recognisedText1 =
        await textDetector.processImage(InputImage.fromFilePath(output1.path));
    final recognisedText2 =
        await textDetector.processImage(InputImage.fromFilePath(output2.path));
    final recognisedText3 =
        await textDetector.processImage(InputImage.fromFilePath(output3.path));
    final recognisedText4 =
        await textDetector.processImage(InputImage.fromFilePath(output4.path));
    final recognisedText5 =
        await textDetector.processImage(InputImage.fromFilePath(output5.path));
    final recognisedText6 =
        await textDetector.processImage(InputImage.fromFilePath(output6.path));
    final recognisedText7 =
        await textDetector.processImage(InputImage.fromFilePath(output7.path));
    final recognisedText8 =
        await textDetector.processImage(InputImage.fromFilePath(output8.path));
    print("No Error");
    //ends here
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => Display1Pic(
          ...
          gocr: recognisedText.text,
          gocr1: recognisedText1.text,
          gocr2: recognisedText2.text,
          gocr3: recognisedText3.text,
          gocr4: recognisedText4.text,
          gocr5: recognisedText5.text,
          gocr6: recognisedText6.text,
          gocr7: recognisedText7.text,
          gocr8: recognisedText8.text,
...
//               await FlutterNativeImage.getImageProperties(image.path);
//           File output = await FlutterNativeImage.cropImage(
//               image.path, 0, 0, properties.width!, properties.height! ~/ 4);
...
//           print("length" + xLength.toString() + yLength.toString());
      ...
      // File output1 = await FlutterNativeImage.cropImage(
      //     image.path, 0, 0, properties.width!, 160);
